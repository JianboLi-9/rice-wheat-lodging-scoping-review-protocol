# Protocol v2.0 FINAL — Full Protocol

> **FINAL**  
> **FINAL CONTENT FROZEN — PUBLIC REGISTRATION HOLD**  
> **FORMAL DATABASE SEARCH NOT STARTED**
...
**Stage:** Stage 2 completed; pre-formal-search protocol finalization  
**Status:** FINAL CONTENT FROZEN; PUBLIC REGISTRATION HOLD; FORMAL DATABASE SEARCH NOT STARTED
...
因此，本项目确定：**Protocol v2.0 FINAL will be publicly released before Stage 3 formal database searching and before formal source selection.** Approved repository: **Open Science Framework (OSF)**. Preferred registration type: **Generalized Systematic Review registration**. No OSF submission is made in this task. The D-drive copy remains a local audit/working copy and cannot substitute for the public registration.
...
**Stage 2 search-strategy development complete. Protocol content FINAL FROZEN. Formal database search NOT started. Public registration status: HOLD.** Scopus is excluded from the prespecified formal set for access/resource reasons; CNKI remains an approved future Chinese-language evidence-identification source and was not formally searched. HG-01 IEEE terminology verification is closed; the remaining hold is limited to OSF contributor metadata and human Register/Submit action.

Protocol v2.0 FINAL is ready for human OSF registration. It must be publicly registered before Stage 3 formal database searching and before formal source selection. Development searches used to construct and validate the protocol search strategy are not formal review searches and are not PRISMA identification counts.
